...
const char *IgorException::what() const noexcept { return m_errorMsg.c_str(); }

int IgorException::GetErrorCode() const noexcept { return m_errorCode; }

int IgorException::HandleException() const { return HandleException(false); }
...
int HandleException(const IgorException &e) { return e.HandleException(); }
