...
#define MAXCMDLEN 2500		// Your XOP will require Igor Pro 8.00 or later
...
#define NOTEBOOK_ACTION_OBJECT 16
#define FIRST_OBJECT_TYPE 1
#define LAST_OBJECT_TYPE 16
...
#define WAVEWAVE_TYPE 0x00020000	// Used with WAVE_TYPE to signify WAVE/WAVE parameter with CheckFunctionForm
...
// Used with CheckFunctionForm when calling a function that has no direct return value because it uses multiple return syntax
