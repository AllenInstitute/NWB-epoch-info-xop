...
#define XOP_FEATURE_DEFAULT_FLAGS XOP_FEATURE_LONG_NAMES		// Default value for this field
...
#define XOP_TOOLKIT_VERSION 801			// 801 means XOP Toolkit 8.01
...
#define TEXT_TYPE	0x0000					// Used only with WAVE_TYPE to indicate a text wave reference parameter when declaring a pass-by-reference wave parameter
// WAVEWAVE_TYPE does not fit in 16 bits and so can not be used in an XOPF resource
// #define WAVEWAVE_TYPE 0x00020000			// Used with WAVE_TYPE to signify WAVE/WAVE parameter (requires Igor Pro 8.00 or later)
